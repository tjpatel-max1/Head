#Added stop on fail + stop on 0.5 usage
import os
import re
import sys
import m3u8
...
#........................................................................................................................................................................................
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if STOP_BATCH_ON_ERROR:
                print("🛑 Batch force stopped after failure")
...
#........................................................................................................................................................................................
            ...
            if "acecwply" in url:
                ...
                # ✅ Testbook → DO NOT USE API
                print("📺 Testbook URL detected → skipping API")
                mpd = None
                keys_string = ""

            elif "classplusapp.com/drm/" in url:

                # ✅ Classplus DRM → SINGLE API CALL ONLY
...
#........................................................................................................................................................................................           
                if "drive" in url:
                    ...
                    if STOP_AFTER_CURRENT:
                        await bot.send_message(
                            channel_id,
                            '🛑 Batch stopped automatically (API 0.50 tier)'
                        )
                        return
                ...
                await bot.send_message(
                    channel_id,
                    f'⚠️ **Batch Stopped (Download Failed)** ⚠️\n'
                    f'**Name** =>> `{str(count).zfill(3)} {name1}`\n'
                    f'**Url** =>> {url}\n\n'
                    f'<blockquote expandable><i><b>Failed Reason: {str(e)}</b></i></blockquote>',
