...
def fetch_cp_drm_keys(video_url):
    try:
        if not CP_DRM_API:
            raise Exception("CP_DRM_API not set")

        api_call = CP_DRM_API.replace("{url}", video_url)
        ...
        if not mpd or not keys:
            raise Exception("Invalid DRM response")
...
#........................................................................................................................................................................................           
                ...
                elif ('drmcdni' in url or 'drm/wv' in url or 'drm/common' in url or ".mpd" in url):
                    prog = await bot.send_message(channel_id, Show, disable_web_page_preview=True)
                    prog1 = await m.reply_text(Show1, disable_web_page_preview=True)
